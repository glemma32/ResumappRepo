...
public class RoboResumeapp {
	...
	public static void main(String[] args) {
				...
				String userInput= "";
		            ...
		            String x = "Insert into PersonalInfo(FirstName, LastName,EmailAddress) values (?,?,?)";
					pstmt = con.prepareStatement("Insert into PersonalInfo(FirstName, LastName,EmailAddress) values (?,?,?)");
					...
					do{
					    ...
					    String s = "Insert into Skills(SFields, Rating) values (?,?)";
